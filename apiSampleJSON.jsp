...
<form name="form" id="form" method="post">
	...
	<input type="text" name="countPerPage" value="7"/><!-- 요청 변수 설정 (페이지당 출력 개수. countPerPage 범위 : 0 < n <= 100) -->
	<input type="text" name="resultType" value="json"/> <!-- 요청 변수 설정 (검색결과형식 설정, json) --> 
	<input type="text" name="confmKey" value="devU01TX0FVVEgyMDI1MDUyNzAwMDQzNjExNTc4NDQ="/><!-- 요청 변수 설정 (승인키) -->
